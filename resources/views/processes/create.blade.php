...
<html lang="en">
  <head>
    ...
    <title>Form Process and Methods</title>
        ...
        <div class="row">
            <div class="col">
                <div class="heading">Form Fields</div>
                    <form action="/processes" method="post" enctype="multipart/form-data">
                        <br>
                        @csrf
                    <input required="" class="input" type="text" style="width: 500px;" name="process" id="process" placeholder="Process">
                    <br>
                    <br>
                    ...
                    <div class="row mt-2">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="audio" id="audio" style="width: 500px;"required><br><br> 
                            </div>
                        </div>
                    <br>
