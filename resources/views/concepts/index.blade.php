...
<div class="container pt-5 mt-4" id="concepts">
    <header class="text-center my-5">
    <h1 class="display-5 font-weight-bold">CONCEPTS</h1>
    </header>
</div>
...
@foreach($conceptCont as $conceptVist)
    <div class="col-lg-4 col-md-6 col-sm-12 mb-4 py-2 d-flex justify-content-center"> 
        <div class="card" style="width: 18rem;">
            ...
            <span class="mb-4">{{$conceptVist->description}}</span>
            <div class="col">
            <audio id="audioPlayer" class="pt-3" controls>
            <source src="audios/concepts/{{$conceptVist->audio}}" width="200" type="audio/mp3">
            </audio>
            <br>
