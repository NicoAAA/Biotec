            ...
            <div class="col">
                <div class="heading">Form Fields</div>
                    <form action="/concepts" method="post" enctype="multipart/form-data">
                        <br>
                        @csrf
                    <input required="" class="input" type="text"  style="width: 500px;" name="concept" id="concept" placeholder="Concept">
                    <br>
                    <br>
                    <input required="" class="input" style="width: 500px; height: 100px;" type="text" name="description" id="description" placeholder="Description">    
                    <div class="row mt-2">
                            <div class="col">
                                <!--<label for="file" class="custum-file-upload">
                                 ...
                                 <label for="img">Select Image File</label><br><br>
                            ...
                            <div class="col">
                                ...
                                <input type="text"  style="width: 500px;" name="audio" id="audio" required><br><br> 
                            </div>
                        </div>
                    <br>
